...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`梁Admin Bot梁\n
👀 Tên: Nguyễn Văn Phước ( NVP )
❎ Tuổi: 15
👤 Giới tính: Nam
💘 Mối quan hệ: Hẹn Hò
🌎 Quê quán: Khánh Hòa ( Nha Trang  - 79 )
👫 Gu: Biết nấu cơm
🌸 Tính cách: Chả biết nữa =))
🌀 Sở thích: Chơi game, ăn, ngủ
💻Contact💻
☎ Zalo:058.6284.453
🌐 Facebook: https://www.facebook.com/NVP.Vanphuoc/
✉️ Email: Contact.vanphuoc@gmail.com`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100021446501428}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(
